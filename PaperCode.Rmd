...
BootStrapRESA$CoLLON %>% PlotClassDiff()
BootStrapRESB$CoLLON %>% PlotClassDiff()
...
testCol <- DistribCompareBootstrapper(CoLLONDATA,1652, 1000, PropertyTypes = c("D", "S", "T", "F"))

testColA <- DistribCompareBootstrapper(CoLLONDATA,1652, 1000, "A", PropertyTypes = c("D", "S", "T", "F"))
testColB <- DistribCompareBootstrapper(CoLLONDATA,1652, 1000, "B", PropertyTypes = c("D", "S", "T", "F"))

all_equal(Boottest$CoLLON, testCol)

all_equal(Boottest$CoLLON, BootStrapRES$CoLLON)

testCol %>% PlotClassDiff()
